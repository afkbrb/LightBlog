    ...
    <script type="text/javascript">
        ...
        function deleteLink() {
            ...
            $.messager.confirm("系统提示", "您确定要删除这<font color=red>" + selectedRows.length + "</font>条数据吗？", function (r) {
                if (r) {
                    $.post("${pageContext.request.contextPath}/admin/link/delete/" + ids, {}, function (result) {
                        if (result == "success") {
        ...
        function openLinkAddDialog() {
            ...
            url = "${pageContext.request.contextPath}/admin/link/insert";
        }
        ...
        function openLinkModifyDialog() {
            ...
            $("#fm").form("load", row);
            url = "${pageContext.request.contextPath}/admin/link/update/" + row.id;
        }
...
<table id="dg" title="友情链接管理" class="easyui-datagrid"
    ...
    <tr>
        ...
        <th field="linkOrder" width="100" align="center">排序序号</th>
    </tr>
    </thead>
</table>
<div id="tb">
...
<div id="dlg" class="easyui-dialog" style="width:500px;height:200px;padding: 10px 20px"
    ...
    <form id="fm" method="post">
        <table cellspacing="8px">
            ...
            <tr>
                <td>友情链接排序：</td>
                <td><input type="text" id="linkOrder" name="linkOrder" class="easyui-numberbox" required="true"
